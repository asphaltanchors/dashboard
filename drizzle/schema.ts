import { pgTable, pgSchema, text, numeric, bigint, date, varchar, boolean, integer, timestamp, doublePrecision, json } from "drizzle-orm/pg-core"
...
export const martCompanyPeriodMetricsInAnalyticsMart = analyticsMart.table("mart_company_period_metrics", {
	...
	lifetimeTotalRevenue: numeric("lifetime_total_revenue"),
...
export const fctInventoryHistoryInAnalyticsMart = analyticsMart.table("fct_inventory_history", {
	...
	openPoQuantity: numeric("open_po_quantity"),
	...
	estimatedTotalVisibility: numeric("estimated_total_visibility"),
...
export const fctInventorySimulationInAnalyticsMart = analyticsMart.table("fct_inventory_simulation", {
	sku: varchar(),
	inventoryDate: date("inventory_date"),
	salesQty: numeric("sales_qty"),
	receiptQty: doublePrecision("receipt_qty"),
	netMovement: doublePrecision("net_movement"),
	simulatedBeginningInventory: doublePrecision("simulated_beginning_inventory"),
	simulatedEndingInventory: doublePrecision("simulated_ending_inventory"),
	openingInventoryAdjustment: doublePrecision("opening_inventory_adjustment"),
	beginningInventory: doublePrecision("beginning_inventory"),
	endingInventory: doublePrecision("ending_inventory"),
	isStockoutDay: integer("is_stockout_day"),
	isZeroInventoryDay: integer("is_zero_inventory_day"),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	orderCount: bigint("order_count", { mode: "number" }),
	lineItemCount: numeric("line_item_count"),
	...
	salesPrice: numeric("sales_price"),
	purchaseCost: numeric("purchase_cost"),
	inventoryValueAtCost: doublePrecision("inventory_value_at_cost"),
	inventoryValueAtSalesPrice: doublePrecision("inventory_value_at_sales_price"),
});
...
export const bridgeCustomerCompanyInAnalyticsMart = analyticsMart.table("bridge_customer_company", {
	...
	currentBalance: varchar("current_balance"),
...
export const fctInventoryForecastInAnalyticsMart = analyticsMart.table("fct_inventory_forecast", {
	sku: varchar(),
	quantityOnHand: numeric("quantity_on_hand"),
	quantityOnOrder: numeric("quantity_on_order"),
	quantityOnSalesOrder: numeric("quantity_on_sales_order"),
	availableQty: numeric("available_qty"),
	projectedQty: numeric("projected_qty"),
	inventorySite: varchar("inventory_site"),
	inventorySiteLocation: varchar("inventory_site_location"),
	minReorderPoint: numeric("min_reorder_point"),
	maxReorderPoint: numeric("max_reorder_point"),
	isBelowMinReorder: boolean("is_below_min_reorder"),
	snapshotDate: varchar("snapshot_date"),
	loadDate: varchar("load_date"),
	salesDescription: varchar("sales_description"),
	productFamily: text("product_family"),
	...
	medianDailyQty30D: doublePrecision("median_daily_qty_30d"),
	avgDailyQty30D: doublePrecision("avg_daily_qty_30d"),
	totalQty30D: doublePrecision("total_qty_30d"),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	daysWithSales30D: bigint("days_with_sales_30d", { mode: "number" }),
	orderCount30D: numeric("order_count_30d"),
	p80DailyQty90D: doublePrecision("p80_daily_qty_90d"),
	p80DailyQty365D: doublePrecision("p80_daily_qty_365d"),
	totalQty90D: doublePrecision("total_qty_90d"),
	totalQty365D: doublePrecision("total_qty_365d"),
	velocityTrendPct30DVs90D: doublePrecision("velocity_trend_pct_30d_vs_90d"),
	velocityTrendPct90DVs365D: doublePrecision("velocity_trend_pct_90d_vs_365d"),
	demandTrend: text("demand_trend"),
	firstSaleDate: date("first_sale_date"),
	lastSaleDate: date("last_sale_date"),
	totalQtyAllTime: doublePrecision("total_qty_all_time"),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	daysWithSalesAllTime: bigint("days_with_sales_all_time", { mode: "number" }),
	daysRemainingAvailable: numeric("days_remaining_available"),
	daysRemainingProjected: numeric("days_remaining_projected"),
	estimatedStockoutDate: date("estimated_stockout_date"),
	reorderQtyFor90DTarget: numeric("reorder_qty_for_90d_target"),
	reorderQtyFor180DTarget: numeric("reorder_qty_for_180d_target"),
	inventoryValueAtCost: numeric("inventory_value_at_cost"),
	inventoryValueAtRetail: numeric("inventory_value_at_retail"),
	inventoryStatus: text("inventory_status"),
	hasRecentSales: boolean("has_recent_sales"),
	isActiveSku: boolean("is_active_sku"),
	forecastMonthlyQty: numeric("forecast_monthly_qty"),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	reorderPriorityRank: bigint("reorder_priority_rank", { mode: "number" }),
});
...
export const fctTradeShowLeadsInAnalyticsMart = analyticsMart.table("fct_trade_show_leads", {
	...
	leadDimKey: varchar("lead_dim_key"),
	showName: varchar("show_name"),
	showDate: date("show_date"),
	showLocation: varchar("show_location"),
	showRep: varchar("show_rep"),
	fullName: text("full_name"),
	firstName: text("first_name"),
	lastName: text("last_name"),
	email: text(),
	...
	domainType: text("domain_type"),
	isIndividualEmail: boolean("is_individual_email"),
	companyDomainKey: text("company_domain_key"),
	...
	companyLifetimeRevenue: numeric("company_lifetime_revenue"),
...
export const fctTradeShowPerformanceInAnalyticsMart = analyticsMart.table("fct_trade_show_performance", {
	...
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	companiesConverted30D: bigint("companies_converted_30d", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	companiesConverted90D: bigint("companies_converted_90d", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	companiesConverted180D: bigint("companies_converted_180d", { mode: "number" }),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	companiesConverted365D: bigint("companies_converted_365d", { mode: "number" }),
	revenueAttributed30D: numeric("revenue_attributed_30d"),
	revenueAttributed90D: numeric("revenue_attributed_90d"),
	revenueAttributed180D: numeric("revenue_attributed_180d"),
	revenueAttributed365D: numeric("revenue_attributed_365d"),
	totalLifetimeRevenueAllMatches: numeric("total_lifetime_revenue_all_matches"),
	avgDaysToFirstOrder: numeric("avg_days_to_first_order"),
	minDaysToFirstOrder: integer("min_days_to_first_order"),
	maxDaysToFirstOrder: integer("max_days_to_first_order"),
...
export const baseFctOrdersCurrentInAnalyticsMart = analyticsMart.view("base_fct_orders_current", {	orderNumber: varchar("order_number"),
	...
	itemCount: bigint("item_count", { mode: "number" }),
	effectiveTaxRate: numeric("effective_tax_rate"),
}).as(sql`SELECT fct_orders.order_number, fct_orders.source_type, fct_orders.order_date, fct_orders.customer, fct_orders.payment_method, fct_orders.status, fct_orders.due_date, fct_orders.primary_contact_id, fct_orders.primary_contact_name, fct_orders.primary_contact_email, fct_orders.primary_contact_phone, fct_orders.primary_contact_role, fct_orders.is_tax_exempt, fct_orders.is_paid, fct_orders.is_backdated, fct_orders.billing_address, fct_orders.billing_address_city, fct_orders.billing_address_state, fct_orders.billing_address_postal_code, fct_orders.billing_address_country, fct_orders.shipping_address, fct_orders.shipping_address_city, fct_orders.shipping_address_state, fct_orders.shipping_address_postal_code, fct_orders.shipping_address_country, fct_orders.primary_country, fct_orders.country_category, fct_orders.region, fct_orders.shipping_method, fct_orders.ship_date, fct_orders.sales_channel_source, fct_orders.acquisition_channel, fct_orders.utm_source, fct_orders.utm_medium, fct_orders.utm_campaign, fct_orders.landing_site, fct_orders.referring_site, fct_orders.tracking_number, fct_orders.tracking_company, fct_orders.fulfilled_at, fct_orders.memo, fct_orders.message_to_customer, fct_orders.class, fct_orders.currency, fct_orders.exchange_rate, fct_orders.terms, fct_orders.sales_rep, fct_orders.sales_channel, fct_orders.customer_segment, fct_orders.transaction_id, fct_orders.quickbooks_internal_id, fct_orders.external_id, fct_orders.created_date, fct_orders.modified_date, fct_orders.total_line_items_amount, fct_orders.total_tax, fct_orders.total_amount, fct_orders.item_count, fct_orders.effective_tax_rate FROM analytics_mart.fct_orders WHERE fct_orders.order_date <= CURRENT_DATE`);
