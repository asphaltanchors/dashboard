import { pgTable, pgSchema, varchar, text, date, numeric, boolean, timestamp, doublePrecision, bigint, integer } from "drizzle-orm/pg-core"
...
export const fctOrderLineItemsInAnalyticsMart = analyticsMart.table("fct_order_line_items", {
	...
	standardSalesPrice: doublePrecision("standard_sales_price"),
	standardPurchaseCost: doublePrecision("standard_purchase_cost"),
	marginPercentage: numeric("margin_percentage"),
	marginAmount: doublePrecision("margin_amount"),
});
...
export const fctCompaniesInAnalyticsMart = analyticsMart.table("fct_companies", {
	...
	totalCurrentBalance: doublePrecision("total_current_balance"),
	...
	enrichedEmployeeCount: integer("enriched_employee_count"),
	...
	enrichmentDate: timestamp("enrichment_date", { mode: 'string' }),
...
export const fctProductsInAnalyticsMart = analyticsMart.table("fct_products", {
	...
	salesPrice: doublePrecision("sales_price"),
...
export const fctInventoryHistoryInAnalyticsMart = analyticsMart.table("fct_inventory_history", {
	...
	quantityOnHand: doublePrecision("quantity_on_hand"),
	quantityOnOrder: doublePrecision("quantity_on_order"),
	quantityOnSalesOrder: doublePrecision("quantity_on_sales_order"),
	availableQuantity: doublePrecision("available_quantity"),
	totalInventoryVisibility: doublePrecision("total_inventory_visibility"),
	previousQuantityOnHand: doublePrecision("previous_quantity_on_hand"),
